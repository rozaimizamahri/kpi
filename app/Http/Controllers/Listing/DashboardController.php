...
{
    public function dashboard(Request $request, $appId){
                ...
                if(count($curr_assignees) > 0){
                    ...
                    {   
                        ...
                        // Quarter
                            ...
                            $quarter_2_arrs[] = $quarter_1_dashboards->assignee_approved_is; // 18
                            $quarter_2_arrs[] = $quarter_1_dashboards->approver; // 19
                                    ...
                                    foreach($perspective_dashboards as $perspective_dashboard) { 
                                        ...
                                        if(count($perspective_2_dashboards) > 0){   
                                            ...
                                            foreach($perspective_2_dashboards as $perspective_2_dashboard) {  
                                                ...
                                                $arr2s[] = $perspective_2_dashboard->main_target_type; // 16
