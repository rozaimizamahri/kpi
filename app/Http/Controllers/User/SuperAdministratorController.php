...
class SuperAdministratorController extends Controller
{
    public function index(Request $request){
        ...
        return view('users.superadministrator',
                [
                    'users'      => $users
                ]
            );
    ...
    public function add(Request $request){
        ...
        $level_access           = htmlentities($request->get('level_access_add'));
        $module_access          = htmlentities($request->get('module_access_add'));
        $approver_access        = htmlentities($request->get('approver_access_add'));
        ...
        if(count($checks) > 0){
            ...
            $users = Users::insert(
                [  
                    ...
                    'approver_access'   => $approver_access,
                    'active'            => 'Y', 
    ...
    public function edit(Request $request){
        ...
        $level_access           = htmlentities($request->get('level_access_edit')); 
        $module_access           = htmlentities($request->get('module_access_edit')); 
        $approver_access         = htmlentities($request->get('approver_access_edit')); 
    ...
    public function delete(Request $request){
        ...
        $user_id                = htmlentities($request->get('user_id_delete')); 
