    ...
    <!-- ============================================================== -->
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor">Reassign 5</h3>
            </div>
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li> 
                    <li class="breadcrumb-item">Task</li>
                    <li class="breadcrumb-item active">Reassign 5 (Open 1st, 2nd & 3rd)</li>
                </ol>
            </div>
            <div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
                                ...
                                <form id='form-reassign' class="form-reassign" name="form-reassign" action="{{url('/head/reassigns/updateReassign5')}}" method="post"> 
                                @csrf  
                                    ...
                                    <div class="form-body"> 
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9"> 
                                                    <select id="level_select" class="form-control select2 custom-select level_select" name="level_select" style="width: 100%;"> 
                                                        ...
                                                        <option value="L1">1st Level</option>  
                                        ...
                                        <div class="row"  id="L1_type" style="display:none;">
                                            <div class="col-md-6">
                                                <div class="form-group"> 
                                                    <label class="control-label">1st Level</label> 
                                                    <select id="team_1" class="select2 m-b-10 select2-multiple team_1" name="team_1[]" style="width: 100%" multiple="multiple" data-placeholder="Please select name (click on the dropdown and wait until list appear)">
