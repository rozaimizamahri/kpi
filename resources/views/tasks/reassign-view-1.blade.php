    ...
    <!-- ============================================================== -->
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor">Reassign 1</h3>
            </div>
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li> 
                    <li class="breadcrumb-item">Task</li>
                    <li class="breadcrumb-item active">Reassign 1 (Open 1st Level Assignee Only)</li>
                </ol>
            </div>
            <div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
                                ...
                                <form id='form-reassign' class="form-reassign" name="form-reassign" action="{{url('/head/reassigns/updateReassign1')}}" method="post"> 
                                @csrf  
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group"> 
                                                    <label class="control-label">Reassign Assignee 1st Level only since 1st level is assigned to team</label> 
