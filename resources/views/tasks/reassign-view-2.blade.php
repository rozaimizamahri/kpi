    ...
    <!-- ============================================================== -->
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor">Reassign 2</h3>
            </div>
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li> 
                    <li class="breadcrumb-item">Task</li>
                    <li class="breadcrumb-item active">Reassign 2 (Open 1st & 2nd)</li>
                </ol>
            </div>
            <div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
                                ...
                                <form id='form-reassign' class="form-reassign" name="form-reassign" action="{{url('/head/reassigns/updateReassign2')}}" method="post"> 
                                @csrf  
