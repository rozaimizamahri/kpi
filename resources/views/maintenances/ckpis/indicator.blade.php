    ...
    <!-- ============================================================== -->
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor">Indicator</h3>
            </div>
                                        ...
                                        @csrf 
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9"> 
                                                        <input type="text" id="name_add" class="form-control name_add" name='name_add' value="" placeholder="">
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <!-- <form id='form-edit' class="form-edit" name="form-edit" action="{{url('/ckpis/ils/edit')}}" method="post">  -->
                                        ...
                                        <input type="hidden" id="id_edit" class="form-control id_edit" name='id_edit' value="" placeholder="" readonly="readonly">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-3"><font color="red">*</font>Name</label>
                                                    <div class="col-md-9"> 
                                                        <input type="text" id="name_edit" class="form-control name_edit" name='name_edit' value="" placeholder="">
                                                        <small class="form-control-feedback"></small> 
                                                    </div>
                                                </div>
                                            </div>  
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form id='form-delete' class="form-delete" name="form-delete" action="{{url('/ckpis/ils/delete')}}" method="post"> 
                                        @csrf 
                        ...
                        <div class="col-lg-12 col-md-12"> 
                            <div class="card card-default">
                                ...
                                <div class="card-body collapse show">  
                                    ...
                                    <button type="button" class="btn btn-xs btn-success" onClick="addIndicator('<?php echo htmlentities('1'); ?>');" ><i class="mdi mdi-library-plus"> New Indicator</i></button>   
                                    <br/>
                                    <br/>

                                    <form id='form-ils' class="form-ils" action="" method="post">
                                    @csrf 
                                        <div class="table-responsive"> 
                                            <table id="table-ils" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <?php 
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="javascript:void(0)" onClick="editIndicator('<?php echo htmlentities($parameter); ?>')" class="btn btn-xs btn-warning">
                                                                        <i class="mdi mdi-table-edit">Edit</i>
                                                                    </a>
                                                                </td>  
                                                                <!-- <td>
                                                                    <a href="javascript:void(0)" onClick="deleteIndicator('<?php //echo htmlentities($parameter); ?>')" class="btn btn-xs btn-danger">
                                                                        <i class="mdi mdi-delete-circle">Delete</i>
                                                                    </a>
                                                                </td>  -->
                                                                <td><?php echo $il->il_value; ?></td> 
                                                                <td><?php echo $il->il_description; ?></td> 
                                                                <td><?php echo $il->il_created_by_name; ?></td> 
                                                                <td><?php echo $il->il_created_by_date2; ?></td> 
                                                                <td><?php echo $il->il_updated_by_name; ?></td> 
                                                                <td><?php echo $il->il_updated_by_date2; ?></td> 
                                                                <td><?php echo $il->il_created_remark; ?></td> 
                                                            </tr> 
                                                        <?php
                                                        }
                                                    ?>
...
<script>
                ...
                $('#info_add').click(function(){ 
                    ...
                    { 
                        ...
                        if (result.value) {
                            ...
                            $.ajax({
                                url: '<?php echo url("/ckpis/ils/add"); ?>',
                                type: 'POST',  
    ...
    // Edit
        // Modal
            function editIndicator(getid_old)
            {   
                var il_id_val = htmlEntities(getid_old);
                $.ajax({
                    url: '<?php echo url("/ckpis/ils/fetch"); ?>' ,
                    type: "GET",
                    dataType: "json",
                    data: {"il_id": il_id_val},
                    success: function(data)
                    {  
                        var ar                      = data;   
                        var il_id                   = "";       
                        var il_value                = "";       
                        var il_description          = "";       
                        var il_created_remark       = "";       

                        for (var i = 0; i < ar.length; i++) 
                        {
                            il_id                   = ar[i]['il_id'];          
                            il_value                = ar[i]['il_value'];          
                            il_description          = ar[i]['il_description'];          
                            il_created_remark       = ar[i]['il_created_remark'];          
                        }	 

                        $('#id_edit').val(il_id);   
                        $('#name_edit').val(il_value);   
                        $('#description_edit').val(il_description);   
                        $('#remark_edit').val(il_created_remark);   
                ...
                $('#info_edit').click(function(){ 
                    ...
                    { 
                        ...
                        if (result.value) {
                            ...
                            $.ajax({
                                url: '<?php echo url("/ckpis/ils/edit"); ?>',
                                type: 'POST',  
    ...
    // Delete
        // Modal
            function deleteIndicator(getid_old)
            {   
                var il_id_val = htmlEntities(getid_old);
                $.ajax({
                    url: '<?php echo url("/ckpis/ils/fetch"); ?>' ,
                    ...
                    {  
                        ...
                        $('#id_delete').val(il_id);   
                        $('#name_delete').val(il_value);   
                        $('#description_delete').val(il_description);   
                        $('#remark_delete').val(il_created_remark);   
