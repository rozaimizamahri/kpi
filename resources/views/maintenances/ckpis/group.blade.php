                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <!-- <form id='form-add' class="form-add" name="form-add" action="{{url('/ckpis/gls/add')}}" method="post">  -->
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <!-- <form id='form-edit' class="form-edit" name="form-edit" action="{{url('/ckpis/gls/edit')}}" method="post">  -->
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form id='form-delete' class="form-delete" name="form-delete" action="{{url('/ckpis/gls/delete')}}" method="post"> 
                                        @csrf 
                        ...
                        <div class="col-lg-12 col-md-12"> 
                            <div class="card card-default">
                                <div class="card-header"> 
                                    ...
                                    @if(Session::has('group_added'))
                                        <div class="alert alert-success alert-rounded">
                                            ...
                                            {{Session::get('group_added')}}

                                            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">x</span></button>
                                        </div>
                                    @endif

                                    @if(Session::has('group_edited'))
                                        <div class="alert alert-warning alert-rounded">
                                            <i class="fa fa-check-circle"></i>
                                            {{Session::get('group_edited')}}
                                    ...
                                    @if(Session::has('group_deleted'))
                                        <div class="alert alert-danger alert-rounded">
                                            <i class="fa fa-check-circle"></i>
                                            {{Session::get('group_deleted')}}

                                            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">x</span></button>
                                        </div>
                                    @endif 

                                    @if(Session::has('group_duplicated'))
                                        <div class="alert alert-danger alert-rounded">
                                            <i class="fa fa-check-circle"></i>
                                            {{Session::get('group_duplicated')}}
                                ...
                                <div class="card-body collapse show">  
                                    ...
                                    <button type="button" class="btn btn-xs btn-success" onClick="addGroup('<?php echo htmlentities('1'); ?>');" ><i class="mdi mdi-library-plus"> New Group</i></button>   
                                    <br/>
                                    <br/>

                                    <form id='form-gls' class="form-gls" action="" method="post">
                                    @csrf 
                                        <div class="table-responsive"> 
                                            <table id="table-gls" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <?php 
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="javascript:void(0)" onClick="editGroup('<?php echo htmlentities($parameter); ?>')" class="btn btn-xs btn-warning">
                                                                        <i class="mdi mdi-table-edit">Edit</i>
                                                                    </a>
                                                                </td>  
                                                                <!-- <td>
                                                                    <a href="javascript:void(0)" onClick="deleteGroup('<?php //echo htmlentities($parameter); ?>')" class="btn btn-xs btn-danger">
                                                                        <i class="mdi mdi-delete-circle">Delete</i>
                                                                    </a>
                                                                </td>  -->
                                                                <td><?php echo $gl->gl_value; ?></td> 
                                                                <td><?php echo $gl->gl_description; ?></td> 
                                                                <td><?php echo $gl->gl_created_by_name; ?></td> 
                                                                <td><?php echo $gl->gl_created_by_date2; ?></td> 
                                                                <td><?php echo $gl->gl_updated_by_name; ?></td> 
                                                                <td><?php echo $gl->gl_updated_by_date2; ?></td> 
                                                                <td><?php echo $gl->gl_created_remark; ?></td> 
                                                            </tr> 
                                                        <?php
                                                        }
                                                    ?>
...
<script>
                ...
                $('#info_add').click(function(){ 
                    ...
                    { 
                        ...
                        if (result.value) {
                            ...
                            $.ajax({
                                url: '<?php echo url("/ckpis/gls/add"); ?>',
                                type: 'POST',  
    ...
    // Edit
        // Modal
            function editGroup(getid_old)
            {   
                var gl_id_val = htmlEntities(getid_old);
                $.ajax({
                    url: '<?php echo url("/ckpis/gls/fetch"); ?>' ,
                    type: "GET",
                    dataType: "json",
                    data: {"gl_id": gl_id_val},
                    success: function(data)
                    {  
                        var ar                  = data;   
                        var gl_id               = "";       
                        var gl_value            = "";       
                        var gl_description      = "";       
                        var gl_created_remark   = "";       

                        for (var i = 0; i < ar.length; i++) 
                        {
                            gl_id               = ar[i]['gl_id'];          
                            gl_value            = ar[i]['gl_value'];          
                            gl_description      = ar[i]['gl_description'];          
                            gl_created_remark   = ar[i]['gl_created_remark'];          
                        }	 

                        $('#id_edit').val(gl_id);   
                        $('#name_edit').val(gl_value);   
                        $('#description_edit').val(gl_description);   
                        $('#remark_edit').val(gl_created_remark);   
            ...
            $(document).ready(function(){
                $('#info_edit').click(function(){ 
                    ...
                    { 
                        ...
                        swalWithBootstrapButtons.fire({
                        title:'Update Group ?',
                        text: "Data will be updated once you click on [Update] button.",
                        type: 'warning',
                        showCancelButton: true, 
                        cancelButtonText: 'Cancel',
                        ...
                        if (result.value) {
                            ...
                            $.ajax({
                                url: '<?php echo url("/ckpis/gls/edit"); ?>',
                                type: 'POST',  
    ...
    // Delete
        // Modal
            function deleteGroup(getid_old)
            {   
                var gl_id_val = htmlEntities(getid_old);
                $.ajax({
                    url: '<?php echo url("/ckpis/gls/fetch"); ?>' ,
                    ...
                    {  
                        ...
                        $('#id_delete').val(gl_id);   
                        $('#name_delete').val(gl_value);   
                        $('#description_delete').val(gl_description);   
                        $('#remark_delete').val(gl_created_remark);   
