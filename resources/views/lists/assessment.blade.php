                        ...
                        <div class="card">  
                            ...
                            <!-- Nav tabs -->
                                <ul class="nav nav-tabs profile-tab" role="tablist">
                                    ...
                                    <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#assignee" role="tab"><font color="red">*</font> Details & Declare </a>  </li>  
                                ...
                                <!-- Third Tab -->
                                    <div class="tab-pane active" id="assignee" role="tabpanel">
                                        <div class="card-body"> 
                                            ...
                                            <!-- Upload -->
                                                <div id="modal_file_upload" class="modal fade bs-example-modal-lg" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none; overflow-y:auto;">
                                                    <div class="modal-dialog modal-lg">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h4 class="modal-title" id="myLargeModalLabel">Supporting Document</h4>
                                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                            </div>
                                                            <div class="modal-body">

                                                                <form id="form-file-upload" class="form-file-upload" name="form-file-upload" action="{{url('/ckpis/assessment/fileUpload')}}" method="post" enctype="multipart/form-data"> 
                                                                @csrf
                            
                                                                    <input type="hidden" id="file_id_upload" class="form-control file_id_upload" name='file_id_upload' value="" placeholder="" readonly="readonly"> 
                                                                    <input type="hidden" id="assignee_id_upload" class="form-control assignee_id_upload" name='assignee_id_upload' value="" placeholder="" readonly="readonly"> 
                                                                    <input type="hidden" id="app_id_upload" class="form-control app_id_upload" name='app_id_upload' value="" placeholder="" readonly="readonly"> 

                                                                    <input type="hidden" id="encrypted_upload" class="form-control encrypted_upload" name="encrypted_upload" value="" readonly="readonly">

                                                                    <div class="col-md-12">
                                                                        <div class="form-group row">
                                                                            <label class="control-label text-right col-md-3">Supporting Document (Max 10MB & PDF format only)</label>
                                                                            <div class="col-md-9">    
                                                                                <input type="file" id="fileUser" class="dropify fileUser" name="fileUser" data-max-file-size="10M" />
                                                                            </div>
                                                                        </div>
                                                                    </div>    
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <button type="button" class="btn btn-success waves-effect text-left" id="file_add" >Upload</button>
                                                                    </div>
                                                ...
                                                <div class="card card-default">
                                                    ...
                                                    <div class="card-body collapse show">  
                                                        ...
                                                        @csrf 
                                                            ...
                                                            Step 1 : Fill In YTD Target & YTD Achievement. Please makesure the value is 2 decimal point (i.e 12.00 or -10.00) <br/>
                                                            Step 2 : Click on 'Update' button (Yellow button) to update & save YTD Target & YTD Achievement data into database <br/> <br/>

                                                            Step 3 : Click Upload/Reupload button to upload supporting document (Max 10MB PDF format only) <br/><br/>
                                                            

                                                            To submit to KPI Owner <br/>
                                                            Step 4 : Tick 'Agree' checkbox <br/>
                                                            Step 5 : Fill in remark <br/>
                                                            Step 6 : Click on 'Submit' button (Green button) <br/>
                                                            <br/><br/>
                                                            
                                                            <!-- Checkbox Selected :    -->
                                                            <button type="button" class="btn btn-xs btn-warning updateAssignees"  name="updateAssignees" id="updateAssignees">Update YTD Target & YTD Achievement</button>  
                                                                ...
                                                                <table id="table-assignee" class="display wrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                                                    <thead style="background-color:#5b626b; color:#ffffff;">
                                                                        <tr> 
                                                                            ...
                                                                            <th style="vertical-align:top; word-wrap: break-word;min-width: 150px;max-width: 100px;">YTD Target <font color="red">*</font></th>    
                                                                            <th style="vertical-align:top; word-wrap: break-word;min-width: 150px;max-width: 100px;">YTD Achievement <font color="red">*</font></th>    
                                                                            <th style="vertical-align:top;">Achievement %</th>    
                                                                            <th style="vertical-align:top;">Rating</th>    
                                                                            <th style="vertical-align:top;">Weightage %</th>    
                                                                            <th style="vertical-align:top;">Weightage Score</th>    
                                                                        ...
                                                                        <?php
                                                                            ...
                                                                            ?>  
                                                                                <tr>    
                                                                                    ...
                                                                                    <td style="word-wrap: break-word;min-width: 200px;max-width: 100px;">
                                                                                        <textarea id="ytd_target<?php echo $assignee->assignee_item_id; ?>" class="form-control textarealah ytd_target<?php echo $assignee->assignee_item_id; ?>" name="ytd_target[]" rows="1"><?php echo $assignee->ytd_target; ?></textarea> 
                                                                                    </td> 
                                                                                    <td style="word-wrap: break-word;min-width: 200px;max-width: 100px;">
                                                                                        <textarea id="ytd_achievement<?php echo $assignee->assignee_item_id; ?>" class="form-control textarealah ytd_achievement<?php echo $assignee->assignee_item_id; ?>" name="ytd_achievement[]" rows="1"><?php echo $assignee->ytd_achievement; ?></textarea> 
                                                                                    </td>    
                                                                    ...
                                                                    <?php
                                                                        if(count($files)!=0 ){
                                                                            ...
                                                                            {?> 
                                                                                ...
                                                                                <tr> 
                                                                                    <td>
                                                                                        <a href="javascript:void(0)" onClick="uploadFile('<?php echo htmlentities($file->file_id); ?>','<?php echo htmlentities($file->assignee_id); ?>','<?php echo htmlentities($file->app_id); ?>')" class="btn btn-xs btn-info">
                                                                                            <i class="mdi mdi-table-edit">Upload/Reupload</i>
                                                                                        </a>
                                                                                    </td>  
                                            ...
                                            <!-- List -->
                                                <div class="card card-default">
                                                    ...
                                                    <div class="card-body collapse show">  
                                                        ...
                                                        <form id='form-declare' class="form-declare" name="form-declare" action="{{url('/ckpis/assessment/declare')}}" method="post">
                                                        @csrf 
                                                            ...
                                                            <input type="hidden" id="assignee_id" class="form-control assignee_id" name='assignee_id' value="<?php echo htmlentities($parameter2); ?>" placeholder="" readonly="readonly"> 
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-10">   
                                                                    <font color="red">*</font> I hereby confirm the information detail are correct
                                                                    </div>
                                                                </div>
                                                            </div>  
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group row">
                                                                    <label class="control-label text-right col-md-2">Remarks / Note <font color="red">*</font></label>
                                                                    <div class="col-md-10">  
