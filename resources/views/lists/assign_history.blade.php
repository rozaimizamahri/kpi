                        ...
                        <div class="card">  
                            ...
                            <!-- Nav tabs -->
                                <ul class="nav nav-tabs profile-tab" role="tablist">
                                    ...
                                    <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#declare" role="tab">Nominate Details  </a>  </li> 
                                </ul>
                            <!-- Nav tabs --> 
                                                    ...
                                                    <div class="card-body collapse show">  
                                                        ...
                                                        <?php 
                                                            foreach($assignees as $assignee){?>
                                                                ...
                                                                <small class="text-muted"><i class="mdi mdi-format-title"></i> Assignee Name </small>
                                                                <h6><?php echo $assignee->assignee_name; ?></h6>   
