    ...
    <!-- ============================================================== --> 
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor">Endorse</h3>
            </div>
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li> 
                    <li class="breadcrumb-item active">Endorse</li>  
                </ol>
            </div>
            <div>
                        ...
                        <div class="card">  
                            ...
                            <!-- Nav tabs -->
                                <ul class="nav nav-tabs profile-tab" role="tablist">
                                    ...
                                    <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#declare" role="tab"><font color="red">*</font> Endorse</a>  </li> 
                                </ul>
                            <!-- Nav tabs --> 
                                            ...
                                            <!-- Approve -->
                                                <div class="card card-default">
                                                    ...
                                                    <div class="card-body collapse show">  
                                                        ...
                                                        <form id='form-declare' class="form-declare" name="form-declare" action="{{url('/ckpis/endorse/declare')}}" method="post">
                                                        @csrf 
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-10">   
                                                                    <font color="red">*</font> I hereby confirm the approve detail are correct
                                                                    </div>
                                                                </div>
                                                            </div> 
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-10">  
                                                                        <textarea id="remark_declare" class="form-control remark_declare textarealah" name="remark_declare" rows="2"><?php echo $application->app_endorsed_remark; ?></textarea> 
                                            ...
                                            <!-- Request to Rework -->
                                                <div class="card card-default">
                                                    ...
                                                    <div class="card-body collapse show">  
                                                        ...
                                                        <form id='form-rework' class="form-rework" name="form-rework" action="{{url('/ckpis/endorse/rework')}}" method="post">
                                                        @csrf 
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-10">   
                                                                    <font color="red">*</font> I hereby confirm the rework detail are correct
                                                                    </div>
                                                                </div>
                                                            </div> 
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-10">  
                                                                        <textarea id="remark_rework" class="form-control remark_rework textarealah" name="remark_rework" rows="2"><?php echo $application->app_endorsed_remark; ?></textarea> 
                                                                        <small class="form-control-feedback"></small> 
                                                                    </div>
                                                                </div>
                                                            </div>   
...
<script>
    ...
    // Table
        $(document).ready(function(){
            ...
            // console.log(count_table_rating);
