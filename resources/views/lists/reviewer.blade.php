    ...
    <!-- ============================================================== -->
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor">CKPI List [Reviewer]</h3>
            </div>
                                            ...
                                            <!-- Approve -->
                                                <div class="card card-default">
                                                    ...
                                                    <div class="card-body collapse show">  
                                                        ...
                                                        <form id='form-declare' class="form-declare" name="form-declare" action="{{url('/ckpis/reviewer/declare')}}" method="post">
                                                        @csrf 
                                            ...
                                            <!-- Rework -->
                                                <div class="card card-default">
                                                    ...
                                                    <div class="card-body collapse show">  
                                                        ...
                                                        <form id='form-rework' class="form-rework" name="form-rework" action="{{url('/ckpis/reviewer/rework')}}" method="post">
                                                        @csrf 
        ...
        // Update
            $('#updateAssignees').click(function(){ 
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: '<?php echo url("/ckpis/checker/updateAssignee"); ?>',
                        type: 'POST', 
