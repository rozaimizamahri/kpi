    ...
    <!-- ============================================================== -->
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor">Corporate KPI [Submit]</h3>
            </div>
                        ...
                        <div class="card">  
                            ...
                            <!-- Nav tabs -->
                                <ul class="nav nav-tabs profile-tab" role="tablist">
                                    ...
                                    <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#group" role="tab">Groups </a>  </li>  
                                    <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#perspective" role="tab"><font color="red">*</font> Perspectives </a>  </li> 
                                    <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#indicator" role="tab"><font color="red">*</font> Indicator</a>  </li> 
                                    <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#assignee" role="tab"><font color="red">*</font> Review/Edit </a>  </li> 
                                    <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#declare" role="tab"><font color="red">*</font> Submit / Declare </a>  </li> 
                                </ul>
                            <!-- Nav tabs --> 
                            ...
                            <div class="tab-content">
                                ...
                                <!-- Fourth Tab : Indicator -->
                                    <div class="tab-pane active" id="indicator" role="tabpanel">
                                        <div class="card-body"> 
                                ...
                                <!-- Fifth Tab : Review & Edit -->
                                    <div class="tab-pane" id="assignee" role="tabpanel">
                                        <div class="card-body"> 
                                            ...
                                            <!-- List -->
                                                <div class="card card-default">
                                                    ...
                                                    <div class="card-body collapse show">  
                                                        ...
                                                        <form id='form-declare' class="form-declare" name="form-declare" action="{{url('/ckpis/submit/declare')}}" method="post">
                                                        @csrf 
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-10">   
                                                                    <font color="red">*</font> I hereby acknowledge all the information are correct.
                                                                    </div>
                                                                </div>
                                                            </div> 
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-10">   
                                                                        <select class="form-control select2 endorser_staffno" id="endorser_staffno" name="endorser_staffno" style="width:100%;">
                                                                            <option value="" selected>Tap & type staff name</option>  
                                                                        </select>
                                                                        <small class="form-control-feedback"></small> 
                                                                    </div>
                                                                </div>
...
<script>
    ...
    // Assignees
        // Update
            ...
            //     })
            //     swalWithBootstrapButtons.fire({
            //     title:'Update selected assignees ?',
            ...
            //         $.ajax({
            //             url: '<?php // echo url("/ckpis/submit/updateAssignee"); ?>',
            //             type: 'POST', 
            ...
            //                     Swal.fire(
            //                         'Empty selection!',
            //                         'You need to update at least one assignee',
            //                         'warning'
            //                     )  
            //                 } 
            //                 else if(data=="true")
