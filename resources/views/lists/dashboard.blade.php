    ...
    <!-- ============================================================== -->
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor">CKPI Dashboard</h3>
            </div>
                                                                                            ...
                                                                                            <table id="table-assignee<?php echo $perspective; ?>" class="display wrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                                                                                <thead style="background-color:#5b626b; color:#ffffff;">
                                                                                                    <tr>  
                                                                                                        ...
                                                                                                        <th style="vertical-align:top; min-width: 300px;max-width: 300px;">Indicators</th>   
                                                                                                        <th style="vertical-align:top; min-width: 180px;max-width: 180px;">Unit <br> (Number/Percentage)</th>  
                                                                                                        
                                                                                                        <th style="vertical-align:top; word-wrap: break-word;min-width: 80px;max-width: 80px;">Target <br> <?php echo $application->app_year; ?></th>     
                                                                                                    ...
                                                                                                    <?php  
                                                                                                        ...
                                                                                                        ?> 
                                                                                                            ...
                                                                                                            <tr style="background-color:#5b626b; color:#ffffff;">
                                                                                                                <td style="text-align:center;" colspan="10"><strong>Overall Score</strong><br/> Overall Rating</td> 
                ...
                if( parseFloat(sum_weightage_score1) > parseFloat(b_tlv_value_3) && parseFloat(sum_weightage_score1) <= parseFloat(b_tlv_value_4) ) {  // > 80.00 && <= 115.00
                    ...
                    if( parseFloat(sum_weightage_score1) > parseFloat(b_tlv_value_1) && parseFloat(sum_weightage_score1) <= parseFloat(b_tlv_value_3) ) {  // > 95.00 && <= 100.00
                        ...
                        if( parseFloat(sum_weightage_score1) >= parseFloat(b_tlv_value_0) && parseFloat(sum_weightage_score1) < parseFloat(b_tlv_value_1) ) {  // >= 80.00 && <= 95.00
                            ...
                            if( parseFloat(sum_weightage_score1) < parseFloat(b_tlv_value_0) > parseFloat(total_zero) ) { // < 80.00 > 0.00
                                ...
                                if( parseFloat(sum_weightage_score1) == parseFloat(total_zero) ) { // == 0.00
                                
                                    // $('.sum_rating'+k).val(b_tlv_rating_0); // Rating : 0
                                    $('.sum_rating'+k).html(total_zero); // Rating : 0
