        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">[CKPI] Administrator</li>
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form id='form-add' class="form-add" name="form-add" action="{{url('/ckpis/addUser')}}" method="post"> 
                                            @csrf  
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">  
                                                            <select id="approver_access_add" class="form-control select2 custom-select approver_access_add" name="approver_access_add" style="width: 100%;"> 
                                                                <option value="" selected="selected">Select Approver</option>  
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form id='form-edit' class="form-edit" name="form-edit" action="{{url('/ckpis/editUser')}}" method="post"> 
                                            @csrf  
                    ...
                    <!-- List -->
                        <div class="card card-default">
                            <div class="card-header">
                                ...
                                <h4 class="card-title m-b-0">Corporate KPI Administrator List</h4>
...
<script> 
    ...
    // Add
        ...
        // Populate Staff 
            $.ajax({
                url: '<?php echo url("/ckpis/fetchUsers"); ?>' ,
                type: "GET",
                dataType: "json",
    ...
    // Edit
        // Modal
            ...
            {   
                ...
                $.ajax({
                    url: '<?php echo url("/ckpis/fetchEditDelete"); ?>' ,
                    type: "GET",
                    dataType: "json",
